    ...
    return (
        <div className='sm:flex'>
            <div className='sm:w-1/2'>
                <img className='h-80 w-full' src={chooseImg} alt="" />
            </div>
            <div className='sm:w-1/2 px-6 pt-6 sm:pt-0 sm:pl-8 bg-gray-100 flex items-center'>
                <div>
                    ...
                    <Link to='/about'><button className='btn text-black border border-black bg-white hover:bg-black hover:text-white px-5 py-2 rounded-md mb-4 sm:mb-0'>
