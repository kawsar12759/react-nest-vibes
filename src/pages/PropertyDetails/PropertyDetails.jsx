            ...
            <div className="container mx-auto p-6 space-y-12 ">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="flex flex-col justify-center space-y-4">
                        <h1 className="text-3xl sm:text-4xl font-bold text-gray-800">{property.estate_title}</h1>
                        <div className="flex flex-wrap items-center">
                            <p className="text-xl sm:text-2xl text-green-500 font-semibold mr-3">{property.price}</p>
                            <span
                                className={`inline-block text-xs sm:text-sm font-medium py-1 px-3 rounded-full ${property.status === 'Sale'
                        ...
                        <p className="text-md sm:text-lg text-gray-600">{property.description}</p>
                    ...
                    <div className="mt-2">
                        <h2 className="text-2xl sm:text-3xl font-bold mb-4 text-gray-800">Facilities</h2>
                ...
                <div className="bg-white py-3 rounded-lg ">
                    <h2 className="text-2xl sm:text-3xl font-bold mb-4 text-gray-800">What Our Customers Say</h2>
                    <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                        {property.reviews.map((review, index) => (
                            <div key={index} className="shadow-md flex flex-col rounded-lg p-4 h-full">

                                <div className="flex-grow mb-3">
                                    <p className="text-lg sm:text-xl font-semibold text-gray-800 mb-4">{review.name}</p>
                                    <p className="text-sm sm:text-md text-gray-600">{review.comment}</p>
                                </div>
                                <div className="flex  justify-end ">
                                    <p className="text-xs sm:text-sm text-[#FF6F00] border border-[#FF6F00]  px-3 py-1 rounded-full">Rating: {review.rating}</p>
                                </div>
